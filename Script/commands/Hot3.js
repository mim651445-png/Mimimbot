...
module.exports.config = {
  ...
  description: "🎬 Random video with funny caption",
...
const videoLinks = [
  ...
  "https://drive.google.com/uc?export=download&id=1sxPeSpyIXO-hitBSGElJBzasuS"
];

// ==================================================
// 😂 Random Funny Captions
// ==================================================

const funnyCaptions = [
  "😂 ভিডিওটা দেখো, হাসি আটকাতে পারলে তুমি জিনিয়াস!",
  "🤣 সাবধান! এই ভিডিও দেখে সিরিয়াস থাকা নিষেধ!",
  "😎 HOT3 হাজির—এবার বিনোদনের দায়িত্ব আমার!",
  "🫣 ভিডিও ছোট, কিন্তু লজ্জা অনেক বড়! 😂",
  "🤭 দেখার আগে মানসিকভাবে প্রস্তুত হয়ে নাও!",
  "😂 যে হাসবে না, তার হাসির ডাটা শেষ!",
  "🐸 এই ভিডিওর কোনো যুক্তি নেই, শুধু বিনোদন আছে!",
  "🤣 মাথা খারাপ করার জন্য ভিডিওটি যথেষ্ট!",
  "😜 স্ক্রল কইরো না—আগে এটা দেখে যাও!",
  "🔥 HOT3 এসেছে, গ্রুপের শান্তি এখন শেষ! 😂",
  "👀 চোখ খোলা রাখো, মিস করলে আফসোস করবে!",
  "🤣 ভিডিওটা এত সুন্দর যে ব্যাখ্যা করার মতো কিছুই নেই!",
  "🫠 দেখে যদি চুপ থাকো, তাহলে তুমি সত্যিই শক্ত মানুষ!",
  "😂 একবার দেখলে আবার দেখতে ইচ্ছা করবে—দোষ আমার না!",
  "😎 Entertainment delivered successfully ✅😂",
  "🤪 আজকের বিনোদন বিভাগে তোমার উপস্থিতি আবশ্যক!",
  "😂 হাসির চার্জ শেষ হওয়ার আগে ভিডিওটা দেখে নাও!",
  "🙈 চোখ বন্ধ করলে ভিডিও দেখবে কীভাবে? তাই খুলে রাখো! 😂",
  "🤣 WARNING: অতিরিক্ত হাসির সম্ভাবনা আছে!",
  "😏 HOT3 অন, এখন গ্রুপে সিরিয়াস ভাব বন্ধ!"
];
...
function getRandomVideo() {
  ...
  return getRandomItem(videoLinks);
}
...
module.exports.run = async function ({ api, event }) {
  try {
    ...
    const caption = getRandomItem(funnyCaptions);
    ...
    console.log("🎬 HOT3 VIDEO:", videoUrl);
    console.log("😂 HOT3 CAPTION:", caption);
    ...
    if (!response || !response.data) {
      throw new Error("Video stream পাওয়া যায়নি");
    }
    ...
    console.error("━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
    console.error("❌ HOT3 VIDEO ERROR");
    ...
    return api.sendMessage(
      ...
      "┃\n" +
      "┃ 🔹 Google Drive ফাইল Public কিনা দেখুন।\n" +
      "┃ 🔹 ভিডিও লিংকটি কাজ করছে কিনা দেখুন।\n" +
      "┃ 🔹 ভিডিওটি অতিরিক্ত বড় হতে পারে।\n" +
      "┃\n" +
      "┃ 👑 Developer: হৃদয় হাসান শান্ত\n" +
      "╰━━━━━━━━━━━━━━━━━━━━╯",
      event.threadID,
